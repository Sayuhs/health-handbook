...
**不处理急症。** 没有分诊、没有行动档位、没有急症提示——全站关于急救的话只有一句，在「免责与许可」页上。这不是功能缺失，是设计决定：真到紧急情况，没有人会打开一个网页。

**不给诊断结论，不给患病概率。** 原因写在「免责与许可」页里：没有查体、化验和病史，那种数字是编出来的，而编出来的概率会让人延误就医。
...
本站是个人整理的资料，不构成诊断或治疗建议。**出现急症请立即拨打 120**，不要在这里查。
