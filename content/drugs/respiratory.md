...
drugs:
  - name: "氨溴索"
    aliases: []
    effect: "祛痰，促进痰液排出"
    brands: ["沐舒坦", "Ambroxol", "兰勃素"]
  - name: "乙酰半胱氨酸"
    aliases: []
    effect: "祛痰，溶解黏痰"
    brands: ["富露施", "易坦静", "Mucomyst"]
  - name: "右美沙芬"
    aliases: []
    effect: "中枢镇咳"
    brands: ["氢溴酸右美沙芬", "普西兰", "Delsym"]
  - name: "沙丁胺醇"
    aliases: ["舒喘灵"]
    effect: "β2受体激动剂，平喘"
    brands: ["万托林", "Ventolin"]
  ...
  - name: "布地奈德"
    aliases: []
    effect: "吸入性糖皮质激素，平喘抗炎"
    brands: ["普米克令舒", "Pulmicort", "雷诺考特"]
  - name: "孟鲁司特钠"
    aliases: []
    effect: "白三烯受体拮抗剂，平喘"
    brands: ["顺尔宁", "Singulair"]
  - name: "茶碱"
    aliases: []
    effect: "磷酸二酯酶抑制剂，平喘"
    brands: ["氨茶碱", "Theophylline"]
  - name: "复方甲氧那明"
    aliases: []
    effect: "平喘镇咳"
    brands: ["阿斯美", "Asmeton"]
